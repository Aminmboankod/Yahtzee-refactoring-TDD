...
### README of the exercise we have in my tutor's repository: [Dfleta repository](https://github.com/dfleta/Python_ejercicios/tree/master/Poo/Yatzy_Refactoring_TDD_Kata)
